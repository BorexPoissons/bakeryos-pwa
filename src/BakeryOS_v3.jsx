    ...
    <div style={{display:"flex",flexDirection:"column",height:"100%",padding:"20px 0"}}>
      ...
      <div style={{padding:"0 8px",flex:1}}>
        ...
        {canChat && (
          <div>
            {/* Bouton toggle */}
            <div className="nb" onClick={function(){
                setSideChat(function(v){
                  if (!v) setSeenCount(otherMsgs); // marquer tous comme lus à l'ouverture
                  return !v;
                });
              }}
              style={{display:"flex",alignItems:"center",gap:8,padding:"10px 10px",borderRadius:8,
...
function Vendeuse(props) {
  ...
  function handleOrder() {
    ...
    setOrderSent(true);
    setOrderDone(true);
    setTimeout(function(){ setOrderDone(false); clearCart(); setOrderSent(false); }, 2200);
  }
  ...
  function onPaid(payInfo) {
    ...
    addSale(sale);
    // Si client nommé ET commande pas déjà envoyée via "Commander" → créer CMD en production
...
function Admin(props) {
  ...
  function exportCSV() {
    ...
    setSavedMsg("✅ Export téléchargé"); setTimeout(function(){ setSavedMsg(""); }, 2200);
  }
